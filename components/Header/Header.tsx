...
export default function() {
  return (
    <div className='bg-[#F3F0EC] shadow-sm p-3 flex items-center lg:justify-end justify-between'>
       <div className='lg:hidden'>
        <Image src={'/mdHome.svg'} alt='header-icon' width={80} height={30}/>
       </div>
       <div className='flex'>
       <div className='w-[222px] lg:w-[400px] bg-white flex p-2 mx-5 rounded-md '>
